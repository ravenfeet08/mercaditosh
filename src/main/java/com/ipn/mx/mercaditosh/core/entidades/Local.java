...
public class Local {
    ...
    @Min(value = 1, message = "El número de local debe ser mayor a 0")
    ...
    @Pattern(
            regexp = "ocupado|disponible|en_mantenimiento",
            message = "El estado debe ser: ocupado, disponible o en_mantenimiento"
    )
